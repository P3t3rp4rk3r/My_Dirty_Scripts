#!/usr/bin/env python
__Program__ = "VirusTotal Signature check & report generation"
...
class Scanner(object):
	...
	CLEAN = 0
		...
		CHECK = CHECK + 1
                print(yellow('< VirusTotal Hasnt Seen This File! Manually Verify!'))
 
            elif entry['positives'] < 1:
		CLEAN = CLEAN + 1		
		continue
 
            elif entry['positives'] > 0:
		VIRUS = VIRUS +1 
                print (red(blink('< This is a virus!!!!!!')))
